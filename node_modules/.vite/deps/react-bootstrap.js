...
import {
  ...
  require_warning
} from "./chunk-TLMJZKD7.js";
import {
  Figure_default,
  Image_default
} from "./chunk-E32TQ3F4.js";
import {
  Button_default as Button_default2
} from "./chunk-4G2SAISC.js";
import {
  Collapse_default,
  createChainedFunction_default
} from "./chunk-V4CPJBMP.js";
import {
  CardHeaderContext_default,
  CardImg_default,
  Card_default,
  divWithClassName_default
} from "./chunk-A4IP2ILQ.js";
import {
  Anchor_default,
  ...
  useUncontrolledProp,
  useWillUnmount
} from "./chunk-2LMDT3FC.js";
import "./chunk-Z4EKDIN5.js";
import {
  Button_default
} from "./chunk-PMA2WYAP.js";
import {
...
import "./chunk-3EFY2KNJ.js";
import {
  createWithBsPrefix
} from "./chunk-MJZTDATD.js";
import {
  DEFAULT_BREAKPOINTS,
...
var Fade = React9.forwardRef(({
  ...
  return (0, import_jsx_runtime7.jsx)(TransitionWrapper_default, {
    ...
    children: (status, innerProps) => React9.cloneElement(children, {
      ...innerProps,
      className: (0, import_classnames7.default)("fade", className, children.props.className, fadeStyles[status], transitionClasses[status])
    })
  });
});
...
function useForceUpdate() {
  var _useReducer = (0, import_react7.useReducer)(function(state) {
    return !state;
...
function useSafeState(state) {
  ...
  return [state[0], (0, import_react8.useCallback)(function(nextState) {
    if (!isMounted())
      return;
...
var $704cf1d3b684cc5c$var$SSRContext = import_react12.default.createContext($704cf1d3b684cc5c$var$defaultContext);
function $704cf1d3b684cc5c$export$9f8ac96af4b1b2ae(props) {
  let cur = (0, import_react12.useContext)($704cf1d3b684cc5c$var$SSRContext);
  ...
  return import_react12.default.createElement($704cf1d3b684cc5c$var$SSRContext.Provider, {
    value
  }, props.children);
}
...
function $704cf1d3b684cc5c$export$619500959fc48b26(defaultId) {
  let ctx = (0, import_react12.useContext)($704cf1d3b684cc5c$var$SSRContext);
...
var DropdownToggle2 = React30.forwardRef(({
  ...
  return (0, import_jsx_runtime25.jsx)(Component2, {
    className: (0, import_classnames18.default)(className, prefix, split && `${prefix}-split`, !!isInputGroup && (dropdownContext == null ? void 0 : dropdownContext.show) && "show"),
    ...toggleProps,
    ...props
  });
});
  ...
  return (0, import_jsx_runtime26.jsx)(DropdownContext_default2.Provider, {
    ...
    children: (0, import_jsx_runtime26.jsx)(Dropdown_default, {
      ...
      children: isInputGroup ? props.children : (0, import_jsx_runtime26.jsx)(Component2, {
        ...props,
        ref,
        className: (0, import_classnames19.default)(className, show && "show", (!drop || drop === "down") && prefix, drop === "up" && "dropup", drop === "end" && "dropend", drop === "start" && "dropstart")
      })
    })
  });
});
...
var Switch = React44.forwardRef((props, ref) => (0, import_jsx_runtime41.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var Modal = (0, import_react33.forwardRef)((_ref, ref) => {
  ...
  if (Transition) {
    dialog = (0, import_jsx_runtime51.jsx)(Transition, {
      appear: true,
      unmountOnExit: true,
      in: !!show,
      onExit,
  ...
  if (backdrop) {
    ...
    if (BackdropTransition3) {
      backdropElement = (0, import_jsx_runtime51.jsx)(BackdropTransition3, {
        appear: true,
        in: !!show,
...
var AbstractModalHeader = React57.forwardRef(({
  ...
  const context5 = (0, import_react34.useContext)(ModalContext_default);
...
AbstractModalHeader.defaultProps = defaultProps14;
...
var Modal2 = React59.forwardRef(({
  ...
  const renderBackdrop = (0, import_react35.useCallback)((backdropProps) => (0, import_jsx_runtime58.jsx)("div", {
    ...backdropProps,
...
var ToastContainer = React97.forwardRef(({
  ...
  return (0, import_jsx_runtime105.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames61.default)(bsPrefix, position && [containerPosition ? `position-${containerPosition}` : null, positionClasses[position]], className)
  });
});
